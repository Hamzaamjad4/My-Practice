...
# Function to find investment amount 2.11
def investment():
...
# Function to find reverse order input 2.13
def reverse():
...
# Function to find are of hexagone 2.15
import math
def hexagon():
...
# Function to find acceleration 2.16
def accelration():
