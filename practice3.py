# Function to find character ASCII code Excercise 3.1

import math
def area_of_pantagon():
...
# Function to find character ASCII code Excercise 3.2
...
# Function to find character ASCII code Excercise 3.3
...
# Function to find character ASCII code Excercise 3.4
...
# Function to find character ASCII code Excercise 3.5
def ASCII():
